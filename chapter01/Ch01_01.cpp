...
{
    const size_t n = 19;
    float x[n], y[n], z1[n], z2[n], z3[n], z4[n];
    ...
    std::cout << std::setw(w) << "z3";
    std::cout << std::setw(w) << "z4" << nl;
    std::cout << std::string(70, '-') << nl;
    ...
    for (size_t i = 0; i < n; i++)
    {
        ...
        std::cout << std::setw(w) << z3[i];
        std::cout << std::setw(w) << z4[i] << nl;
    }
}
